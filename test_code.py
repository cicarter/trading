...
def yahooKeyStats(stock):
    try:
        ...
        ret = soup.find_all('td', attrs={'class' : 'Fz(s) Fw(500) Ta(end)', 'data-reactid' : '61'})
        print(ret)
...
Create a list of stocks (done)

Create a way to update stock instantly
    To start you only need a method that will get relevant stock info
        Create a method that can analyze historical data to see which stocks are important for this time period
        
Create a way to filter data
Create a way to store the data
Create a way to analyze the data
Create a way to create a weight list
